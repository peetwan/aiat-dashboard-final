...
const FIELD_LABELS = {
  ...
  research_leads: "ผู้วิจัยและสังกัด",
  owner_name: "เจ้าของผลงาน",
  rights_owner: "เจ้าของสิทธิ์",
  name: "ชื่อ",
  recorder_name: "ผู้จัดทำข้อมูล",
  recorder_institution: "สังกัดผู้จัดทำ",
  address: "ที่ตั้ง",
  work_contact: "ช่องทางติดต่อ",
...
function renderInnovationDigest(item, fallback) {
  ...
  return `<article class="record-card record-innovation">
    ...
    <details><summary>ดูสาระสำคัญ</summary>${renderFactList([
      [FIELD_LABELS.owner_name, item.owner_name],
