...
def build_public_data(refresh_boundaries: bool) -> None:
        ...
        props.update(
            {
                ...
                "disaster_source_count": profile["disaster_source_count"],
                "disaster_record_count": profile["disaster_record_count"],
                "disaster_sources": profile["disaster_sources"],
    ...
    public_catalog = {
        ...
        "metrics": {
            ...
            "disaster_source_count": {
                "label_th": "แหล่งติดตามภัย SPU ที่มี candidate records",
                "unit": "sources",
                "semantic_status": "candidate_monitoring_coverage_not_certified_disaster_status",
            },
            "disaster_record_count": {
                "label_th": "ระเบียนติดตามภัย SPU ที่เชื่อมกับจังหวัด",
                "unit": "records",
                "semantic_status": "candidate_records_not_certified_disaster_status",
            },
        },
