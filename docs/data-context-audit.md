...
| AppTech MTR | คืนทะเบียน 630 รายการ พร้อมชื่อเจ้าของและช่องทางติดต่อจาก public listing ตรวจ hash ของแต่ละหน้าและจับคู่ ID กับ Silver; coverage แสดงทะเบียน 630 รายการแยกจาก aggregate รายจังหวัด 77 แถว ไม่บวกสอง grain เข้าด้วยกัน |
...
| ท่องเที่ยวลำพูน | คืนหมายเลขบริการฉุกเฉิน 6 รายการ ศูนย์บริการ 3 แห่งพร้อมเบอร์ 7 ช่องและเวลาทำการแยกต่างหาก กลุ่มทำโคม 10 กลุ่ม และหมายเลขบริการเดินทางที่ต้นทางระบุ |
...
- เพิ่ม regression เรื่อง source card, ชื่อผู้รับผิดชอบ 9 รูปแบบ, การคงสังกัดผู้วิจัย, เบอร์โทรและอีเมลที่ติดข้อความไทย, การแยกเวลาทำการ และการปฏิเสธ CLIG ที่จำนวนไม่ครบพร้อม failed manifest ผล pytest และ CI ของ revision ล่าสุดดูที่ PR; test ที่ข้ามต้องใช้ชุด endpoint evidence เต็มนอก public clone
...
- CLIG ทดสอบ connector ผ่าน ResponseRecorder จริงด้วย MockTransport ครบ POST รายการ, GET รายละเอียด และจบ pagination โดยตรวจรูปแบบ form body และ query จาก generated catalog
